    ...
    <v-menu v-model="menu" :close-on-content-click="false" :nudge-width="200" offset-y transition="slide-y-transition">
        ...
        <v-card>
            <v-list>
                ...
                <v-divider></v-divider>
                <a href="/admin/#/dashboard" class="v-list__tile v-list__tile--link" v-for="role in user.roles" :key="role.id" v-if="role.name != 'Client'">
                ...
                <router-link to="/myOrders" v-else class="v-list__tile v-list__tile--link">My orders</router-link>
