                                        ...
                                        <v-card-text>
                                            ...
                                            <v-layout row wrap>
                                                <v-flex sm4>
                                                    ...
                                                    <el-select v-model="form.category" clearable placeholder="Display Name" @change="changeCat()">
                                                ...
                                                <v-flex sm4>
                                                    ...
                                                    <el-select v-model="form.subcategories" clearable placeholder="Display Name">
                                                        <el-option v-for="item in subcategories" :key="item.value" :label="item.name" :value="item.id">
                                                        </el-option>
                                                    </el-select>
                                                </v-flex>
                                                <v-flex sm4>
...
export default {
    ...
    //   this.subcategories = item.sub_categories;
        ...
        axios.get(`/categories/${this.form.category}`)
            .then(response => {
                // this.loader = false;
