                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="Photography">
                                                        <div class="col-sm-6 col-xs-12 col-md-3">
                                                            <div class="thumbnail">
                                                                <a href="single.html"><img src="http://ecommerce.test/storage/products/300x300.png" alt="Generic placeholder thumbnail"></a>
                                                                <div class="caption">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 pull-right">
                                            <div class="mega-dropdown-menu">
                                                <form class="search-form" action="http://www.mirchu.net/themes/BlogDesk/search.php">
